...
Y?(L.DeviceShake=G({extend:K,init:function(){this._super();this.aa=new Y},properties:{dispose:function(){this.unbind();this.d()},bind:function(a){this.aa.bind("DeviceMotion"===Za?function(b){a(b)}:function(b){b={alpha:b.alpha,beta:b.beta,gamma:b.gamma};a(b)})},unbind:function(){this.aa.unbind()}}}),L.DeviceShake.support=l):L.DeviceShake={support:m};
