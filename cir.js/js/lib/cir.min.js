...
this.typeCast(d[1]))}return{mode:a,vars:c}},getHash:function(){return this.parseHash(location.hash)}}});L.Embed=function(a){var b=z(a.type.toLowerCase());b.controls=a.controls?l:m;b.preload=a.preload||"auto";b.autoplay=a.autoplay?l:m;b.loop=a.loop?l:m;b.src=a.dir+a.name+"."+support;return b};
...
h[f]=d.pigment(a);g++}var d=this,f,g=0,h={};b=b||s;for(f in a)c(a[f]);return h},draw:function(a){var b=0,c=a.length,d;for(this.ba.clearRect(0,0,this.p.width,this.p.height);b<c;b++)d=a[b],this.ba.drawImage(d.image,d.x,d.y)}}});
...
h=[]}function d(){f();c()}function f(){if(g.getOrientation().portrait)return a.portrait(),l;a.landscape()}var g=this,h=[];a.immediately&&f();if(a.one)return b(d),function(){c()};b(f);return function(){c()}}}});var Va="ondeviceorientation"in k;L.DeviceOrientation=Va?G({extend:K,init:function(){this._super()},properties:{bind:function(a){this.unbind();this.o=this.contract(k,"deviceorientation",a)},unbind:function(){this.o&&this.uncontract(this.o)}}}):{};L.DeviceOrientation.support=Va;
