...
L.extend=function(a,b){function c(){this.init=a}c.prototype=b.prototype;a.prototype=new c;var d=a.prototype;d._superclass=b;d._super=function(){var a=this.wa,a=a?a.prototype.Oa:this.wa=b;a.apply(this,arguments)}};
...
for(var wa=["webkitAnimation","animation"],xa=z("p"),Ba=m,M,N="",Da="animation",O=0,Ea=wa.length,Fa,Q,R;O<Ea;O++)if(void 0!==xa.style[wa[O]]){Ba=l;if(M=wa[O].match(/^(.*?)animation$/i)[1])N="-"+M.toLowerCase()+"-",Da=M+"Animation";Fa=E(ka("head"),z("style",{type:"text/css"}));Q=Fa.sheet;break}
...
U=Ia?L.Transition=G({extend:K,init:function(a,b,c){c=c||{};c.onComplete=c.onComplete||s;U.id++;this.c="cirtrans"+U.id;var d=[];aa({},b);var e,g=c.duration||U.Duration,h=c.ease||"ease";ha(h)||(h=[h]);for(e in b)d.push(e);e=Ka;for(var p=0,q=h.length,d=""+(e+"transition-property:"+d.join(" ")+";"+e+"transition-duration:"+g+"ms;");p<q;p++)d+=e+"transition-timing-function:"+h[p]+";";T.insertRule("."+this.c+"{"+d+"}",T.cssRules.length);this.a=a;this.i=b;this.Ja=c;c.manual||this.start()},properties:{dispose:function(){this.stop();
this.d()},start:function(){var a=this;a.t=function(b){a.stop();setTimeout(function(){a.Ja.onComplete(b)},1)};A(a.a,La+"End",a.t);A(a.a,"transitionend",a.t);x(a.a,a.c);D(a.a,a.i)},stop:function(){var a=T.cssRules,b=a.length,c;B(this.a,La+"End",this.t);B(this.a,"transitionend",this.t);for(y(this.a,this.c);b--;)if(c=a[b].name||(""+a[b].selectorText).split(".")[1],c===this.c){T.deleteRule(b);break}}}}):L.Transition={};U.id=0;U.support=Ia;U.Duration=500;
var V=L.Tweener=G({extend:K,init:function(a,b,c){var d;c=c||{};this.u=a;this.i=[];for(d in b)a=b[d],a.name=d,a.Ba=a.to-a.from,a.prefix=a.prefix||"",a.suffix=a.suffix||"px",this.i.push(a);this.U=c.duration||V.Duration;this.Ca=c.ease||this.pa;this.D=c.onComplete;c.manual||this.start()},properties:{dispose:function(){this.stop();this.d()},pa:function(a,b,c,d){return c*(-Math.pow(2,-10*a/d)+1)+b},Y:k.requestAnimationFrame?function(a){requestAnimationFrame(a)}:k.webkitRequestAnimationFrame?function(a){webkitRequestAnimationFrame(a)}:
k.mozRequestAnimationFrame?function(a){mozRequestAnimationFrame(a)}:k.oRequestAnimationFrame?function(a){oRequestAnimationFrame(a)}:k.msRequestAnimationFrame?function(a){msRequestAnimationFrame(a)}:function(a){setTimeout(a,1E3/V.La)},loop:function(){for(var a=this,b=V.F,c,d=Date.now(),e,g=b.length,h,p,q;g--;)if(c=b[g],p=c.i.length,e=d-c.za,e<c.U)for(h=0;h<p;h++)q=c.i[h],V.Z(c.u,q,c.Ca(e,q.from,q.Ba,c.U));else{for(h=0;h<p;h++)q=c.i[h],V.Z(c.u,q,q.to);c.D&&c.D();b.splice(g,1)}if(b.length)return a.Y(function(){a.loop()}),
l;this.stop()},start:function(){var a=this;a.za=Date.now();V.F.push(a);V.P||(V.P=1,a.Y(function(){a.loop()}))},stop:function(){V.F=[];clearInterval(V.P);V.P=t}}});V.Z=function(a,b,c){a[b.name]=b.prefix+c+b.suffix};V.F=[];V.FPS=30;V.Duration=500;L.$=function(a,b){var c,d,e=0,g;b=b||v;fa(a)?c=b.querySelectorAll(a):(c=[a],a="");g=c.length;d=function(){};d.prototype=L.$.ia;d=new d;d.length=g;for(d.va=b;e<g;e++)d[e]=c[e];return d};
...
L.$.ia={qa:W,Na:X,Ma:Oa,querySelectorAll:function(a){return this[0].querySelectorAll(a)},find:function(a){return L.$(a,this.va)},parent:function(){return L.$(this[0].parentNode)},on:function(){return W(this,A,arguments)},off:function(){return W(this,B,arguments)},show:function(){return W(this,pa)},hide:function(){return W(this,qa)},opacity:function(){return W(this,ra,arguments)},hasClass:function(){return X(this,w,arguments)},addClass:function(){return W(this,x,arguments)},removeClass:function(){return W(this,
...
Ra&&L.cssease?Qa=L.cssease:L.ease&&(Qa=L.ease);Ua.animate=function(){this.k||(this.k=[]);return Ua.qa(this,Pa,arguments)};Ua.stop=function(){if(this.k){for(var a=0,b=this.k.length;a<b;a++)this.k[a].stop();this.k=t}return this};
...
L.ExternalInterface.Android=G({extend:L.HashQuery,init:function(a){a=a||{};this.xa=a.android;this.da=a.externalObj},properties:{call:function(a){this.xa[a.mode](this.makeHash(a))},addCallback:function(a,b){var c=this;c.da[a]=function(a){a=c.parseHash(a);return b(a.vars)}},removeCallback:function(a){delete this.da[a]}}});
...
var Ya="ondevicemotion"in k;L.DeviceMotion=Ya?G({extend:K,init:function(){this._super()},properties:{bind:function(a){this.unbind();this.o=this.contract(k,"devicemotion",a)},unbind:function(){this.o&&this.uncontract(this.o)}}}):{};L.DeviceMotion.support=Ya;var Y,Za,$a=new C.Mobile;L.DeviceMotion.support?(Y=L.DeviceMotion,Za="DeviceMotion"):L.DeviceOrientation.support&&(Y=L.DeviceOrientation,Za="DeviceOrientation");$a=$a.dispose();
Y?(L.DeviceShake=G({extend:K,init:function(){this._super();this.aa=new Y},properties:{dispose:function(){this.unbind();this.d()},bind:function(a){this.aa.bind("DeviceMotion"===Za?function(b){b=b.rotationRate;b={alpha:b.alpha,beta:b.beta,gamma:b.bamma};a(b)}:function(b){b={alpha:b.alpha,beta:b.beta,gamma:b.gamma};a(b)})},unbind:function(){this.aa.unbind()}}}),L.DeviceShake.support=l):L.DeviceShake={support:m};
...
L.PreRender=G({extend:K,init:function(a){a=a||{};a.loopblur||(a.loopblur=20);this.j=a.elements||[];this.ea=a.guesslimit||30;this.Ia=a.onrendered||s;this.ha=a.looptime||100;this.Ha=this.ha+a.loopblur;a.manual||this.start()},properties:{start:function(){var a;for(a=this.j.length;a--;)pa(this.j[a]);this.n=Date.now();this.h=setInterval(function(a){var c=Date.now(),d=c-a.n;a.n=c;if(d<a.Ha&&(a.ea--,1>a.ea)){clearInterval(a.h);for(c=a.j.length;c--;)qa(a.j[c]);a.Ia()}},this.ha,this)}}});
L.Route=G({extend:K,init:function(a){if(a.single&&L.Route.b)return L.Route.b;this.u=a.target||"";this.sa=a.noregex;this.s=a.action;a.manual||this.start();a.single&&(L.Route.b=this)},properties:{start:function(){this.fire(this.u)},fire:function(a){var b;if(this.sa&&this.s[a])return this.s[a](a);for(b in this.s)if(a.match(b))this.s[b](b)}}});
...
L.Surrogate=G({extend:K,init:function(a){this.Aa=a.delay;this.v=a.callback},properties:{dispose:function(){this.clear();this.d()},request:function(a){this.ya=a;this.clear();this.R=setTimeout(this.flush,this.Aa,this)},flush:function(a){a=a||this;a.v(a.ya)},clear:function(){clearInterval(this.R)}}});
L.Throttle=G({extend:K,init:function(a){this.Ka=a.waittime;this.v=a.callback},properties:{dispose:function(){this.unlock();this.d()},request:function(a){var b=this;if(b.ga)return b.Q=a,m;b.v(a);b.lock();b.R=setTimeout(function(){b.Q&&(b.v(b.Q),b.Q=t);b.unlock()},b.Ka,b)},lock:function(){this.ga=l},unlock:function(a){a=a||this;a.ga=m;clearInterval(a.R)}}});
L.Timer=function(a){function b(){P=Date.now();var a=g-(P-za)/1E3;0>a&&(a=0);Ca=c(a);q(Ca);if(P>Aa)return Wa.stop(),H(),l;Xa=setTimeout(b,p);return m}function c(a){var b;b=(""+a).split(".");a=b[0];b=b[1]?b[1]:"";a=d({ka:a,ca:ya.Fa});b=d({ka:b,ca:ya.Ea,Ga:l});return a+"."+b}function d(a){var b=""+a.ka,c=a.ca,d=c-b.length;return!a.Ga?-1<d?e(d,0)+b:e(c,9):0<d?b+e(d,0):b.slice(0,c)}function e(a,b){var c="";for(b=""+b;0<a;)c+=b,a--;return c}var g=a.limit,h=1E3*g,p=1E3*a.interval,q=a.onupdate,H=a.ontimeup,
ya;a=a.template.split(".");ya={Fa:a[0].length,Ea:a[1].length};var za=0,P=0,Aa=h,Ca=c(g),Xa,Wa={getLimit:function(){return g},getTime:function(){return Ca},getProgress:function(){return 1-(Aa-P)/h},setUpdate:function(a){q=a},setTimeup:function(a){H=a},countDown:function(){P=za=Date.now();Aa=za+h;b()},stop:function(){clearInterval(Xa)}};return Wa};
