...
var Ya="ondevicemotion"in k;L.DeviceMotion=Ya?G({extend:K,init:function(){this._super()},properties:{bind:function(a){this.unbind();this.o=this.contract(k,"devicemotion",a)},unbind:function(){this.o&&this.uncontract(this.o)}}}):{};L.DeviceMotion.support=Ya;var Y,Za,$a=new C.Mobile;$a.isMobile()&&(L.DeviceOrientation.support?(Y=L.DeviceOrientation,Za="DeviceOrientation"):L.DeviceMotion.support&&(Y=L.DeviceMotion,Za="DeviceMotion"));$a=$a.dispose();
Y?(L.DeviceShake=G({extend:K,init:function(){this._super();this.aa=new Y},properties:{dispose:function(){this.unbind();this.d()},bind:function(a){this.aa.bind("DeviceOrientation"===Za?function(b){b={alpha:b.alpha,beta:b.beta,gamma:b.gamma};a(b)}:function(b){b=b.rotationRate;b={alpha:b.alpha,beta:b.beta,gamma:b.gamma};a(b)})},unbind:function(){this.aa.unbind()}}}),L.DeviceShake.support=l):L.DeviceShake={support:m};
